...
class ModelArguments:
    ...
    pretrained_model: str = field(default='roberta-base')
...
class MyTrainingArguments(TrainingArguments):
    ...
    per_query_hard_num: int = field(default=1)
    ...
    quant_weight: float = field(default=1e-6, metadata={"help": "weight for traditional quantization loss"})
